...
function BootSequence({
  ...
  React.useEffect(() => {
    ...
    // Skip — Enter/Esc/Space or any tap/click fast-forwards the boot overlay.
    const skip = () => {
...
// Touch screens fire mousemove on tap but never mouseleave, so magnetic/tilt
// elements get stuck mid-transform. Only attach these FX on hover-capable devices.
